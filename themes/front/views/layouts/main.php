...
/*
 * $cs->registerScriptFile($baseUrl.'/js/jquery-1.4.3.min.js');
$cs->registerScriptFile($baseUrl . '/js/modernizr-1.7.min.js');
$cs->registerScriptFile($baseUrl . '/js/jquery.easing.1.2.js');
$cs->registerScriptFile($baseUrl . '/js/jquery.visualnav.min.js');
$cs->registerScriptFile($baseUrl . '/js/jquery.quicksand.js');
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo $baseUrl; ?>">Modern Business</a>
            </div>
        ...
        <!-- /.container -->
            ...
            <?php include_once(Yii::app()->basePath.'/views/front/site/messages.php') ?>
