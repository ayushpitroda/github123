 ...
 * @property string $answer_dicsrption
...
class QuestionAnswers extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('answer_dicsrption, date_added', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, question_id, answer_dicsrption, user_id, date_added', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'answer_dicsrption' => 'Answer Dicsrption',
			'user_id' => 'User',
	...
	public function search()
	{
		...
		$criteria->compare('answer_dicsrption',$this->answer_dicsrption,true);
